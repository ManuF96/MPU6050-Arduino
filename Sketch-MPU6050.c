...
//Ripeto una volta ogni 5 secondi la lettura completa di giroscopio e accellerometro
  ...
  Serial.println(readGyroX());
  
  Serial.print("Gyro Y: ");//Giroscopio Y
  Serial.println(readGyroY());
  
  Serial.print("Gyro Z: ");//Giroscopio Z
  Serial.println(readGyroZ());
  
  Serial.print("Accel X: ");//Accelerometro X
  Serial.println(readAccelX());
  
  Serial.print("Accel X: ");//Accelerometro Y
  Serial.println(readAccelY());
  
  Serial.print("Accel X: ");//Accelerometro Z
